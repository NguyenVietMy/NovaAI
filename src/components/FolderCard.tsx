...
export default function FolderCard({
  ...
  return (
    <>
      <div
        className="relative w-full h-[80px] rounded-xl flex items-center px-4 cursor-pointer transition-transform hover:shadow-lg hover:scale-[1.03] border border-gray-200"
